...
import functionTelegram from "./function/telegram";
...
export class Server extends EventEmitter {
    ...
    constructor(options: ServerOptions) {
        ...
        if (options.telegram?.token) this.telegramPrivate(options.telegram);
    ...
    private telegramPrivate(options: ServerOptions["telegram"]) {
        if (options) this.telegram = functionTelegram(options);
    }
